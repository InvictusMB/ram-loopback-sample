...
export interface ReviewResponseControllerCreateRequest {
    id: string;
    newReviewResponseInReview?: NewReviewResponseInReview;
}

export interface ReviewResponseControllerDeleteRequest {
    id: string;
    where?: { [key: string]: object; };
}

export interface ReviewResponseControllerReplaceRequest {
    id: string;
    where?: { [key: string]: object; };
    reviewResponsePartial?: ReviewResponsePartial;
}

export interface ReviewResponseControllerUpdateRequest {
    id: string;
    where?: { [key: string]: object; };
    reviewResponsePartial?: ReviewResponsePartial;
}
