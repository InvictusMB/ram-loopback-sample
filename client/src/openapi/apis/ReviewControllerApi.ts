...
export type ReviewControllerCountRequest = {
    where?: runtime.HTTPQuery;
}

export type ReviewControllerDeleteByIdRequest = {
    id: string;
}

export type ReviewControllerFindRequest = {
    filter?: ReviewFilter1;
}

export type ReviewControllerFindByIdRequest = {
    id: string;
    filter?: ReviewFilter;
}

export type ReviewControllerReplaceByIdRequest = {
    id: string;
    review?: Review;
}

export type ReviewControllerUpdateByIdRequest = {
    id: string;
